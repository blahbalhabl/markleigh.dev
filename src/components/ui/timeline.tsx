...
import { AnimatedTitle } from '@/components/shelf';
  ...
  return (
    <div className="w-full bg-transparent" ref={containerRef}>
      <div className="mx-auto max-w-7xl px-4 py-20 text-center md:px-8 lg:px-10">
        <AnimatedTitle
          title="My Projects"
          description="This section highlights the various projects I have undertaken, which
          have significantly contributed to enhancing my skills and expertise in
          the domain of web development and programming. Each project showcases
          my ability to apply theoretical knowledge to practical scenarios,
          thereby demonstrating my growth and proficiency in this field."
        />
        {/* <h2 className="mb-4 max-w-4xl text-lg font-semibold text-accent md:text-4xl">
          My Projects
        </h2>
        <p className="max-w-3xl text-sm text-primary md:text-base">
          This section highlights the various projects I have undertaken, which
          have significantly contributed to enhancing my skills and expertise in
          the domain of web development and programming. Each project showcases
          my ability to apply theoretical knowledge to practical scenarios,
          thereby demonstrating my growth and proficiency in this field.
